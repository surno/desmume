...
// Determine CPU architecture for platforms that don't use the autoconf script
    ...
    defined(_M_X64) || defined(_WIN64) || defined(__aarch64__) ||              \
...
#endif // defined(ENABLE_AVX) || defined(ENABLE_AVX2) ||
       // defined(ENABLE_AVX512_0)
...
#if !defined(OBJ_C) && !defined(__OBJC__)
typedef int BOOL;
#else
...
// Flags used to determine how a conversion function swaps bytes for big-endian
// systems. These flags should be ignored on little-endian systems.
enum BESwapFlags {
  BESwapNone = 0x00, // No byte swapping for both incoming and outgoing data.
                     // All data is used as-is.

  BESwapIn =
      0x01, // All incoming data is byte swapped; outgoing data is used as-is.
  BESwapPre = 0x01, // An alternate name for "BESwapIn"
  BESwapSrc = 0x01, // An alternate name for "BESwapIn"

  BESwapOut =
      0x02, // All incoming data is used as-is; outgoing data is byte swapped.
